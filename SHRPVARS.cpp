...
void initSHRPVars(InfoManager* mConst, InfoManager* mData, InfoManager* mPersist){
...
#ifdef SHRP_REC_TYPE
	string TempString = EXPAND(SHRP_REC_TYPE);
	TempString=std::regex_replace(TempString, std::regex("_"), " ");
	mConst->SetValue("shrp_rec_type", TempString);
#else
    ...
    mConst->SetValue("tw_battery_pos_x", 950);
#endif
...
#ifndef SHRP_NOTCH
	mConst->SetValue("notch_present", "0");
    //Positions variables
    ...
    mConst->SetValue("rPos23", "400");
    mConst->SetValue("rPos24", "415");
    mConst->SetValue("rPos25", "430");
    mConst->SetValue("rPos26", "445");
    ...
    mConst->SetValue("rPos39", "640");
    mConst->SetValue("rPos40", "655");
    mConst->SetValue("rPos41", "670");
    mConst->SetValue("rPos42", "685");
    mConst->SetValue("rPos43", "700");
    mConst->SetValue("rPos44", "715");
    mConst->SetValue("rPos45", "730");
    mConst->SetValue("rPos46", "745");
    mConst->SetValue("rPos47", "760");
    mConst->SetValue("rPos48", "775");
    mConst->SetValue("rPos49", "790");
    mConst->SetValue("rPos50", "805");
    mConst->SetValue("rPos51", "820");
    mConst->SetValue("rPos52", "835");
    mConst->SetValue("rPos53", "850");
    mConst->SetValue("rPos54", "865");
    mConst->SetValue("rPos55", "880");
    mConst->SetValue("rPos56", "895");
    mConst->SetValue("rPos57", "910");
    mConst->SetValue("rPos58", "925");
    mConst->SetValue("rPos59", "940");
    mConst->SetValue("rPos60", "955");
    mConst->SetValue("rPos61", "970");
    mConst->SetValue("rPos62", "985");
    mConst->SetValue("rPos63", "1000");
    mConst->SetValue("rPos64", "1015");
    mConst->SetValue("rPos65", "1030");
    mConst->SetValue("rPos66", "1045");
    mConst->SetValue("rPos67", "1060");
    mConst->SetValue("rPos68", "1075");
    mConst->SetValue("rPos69", "1090");
    mConst->SetValue("rPos70", "1105");
    mConst->SetValue("rPos71", "1120");
    mConst->SetValue("rPos72", "1135");
    mConst->SetValue("rPos73", "1150");
    mConst->SetValue("rPos74", "1165");
    mConst->SetValue("rPos75", "1180");
    mConst->SetValue("rPos76", "1195");
    mConst->SetValue("rPos77", "1210");
    mConst->SetValue("rPos78", "1225");
    mConst->SetValue("rPos79", "1240");
    mConst->SetValue("rPos80", "1255");
    mConst->SetValue("rPos81", "1270");
    mConst->SetValue("rPos82", "1285");
    mConst->SetValue("rPos83", "1300");
    mConst->SetValue("rPos84", "1315");
    mConst->SetValue("rPos85", "1330");
    mConst->SetValue("rPos86", "1345");
    mConst->SetValue("rPos87", "1360");
    mConst->SetValue("rPos88", "1375");
    mConst->SetValue("rPos89", "1390");
    mConst->SetValue("rPos90", "1405");
    mConst->SetValue("rPos91", "1420");
    mConst->SetValue("rPos92", "1435");
    mConst->SetValue("rPos93", "1450");
    mConst->SetValue("rPos94", "1465");
    mConst->SetValue("rPos95", "1480");
    mConst->SetValue("rPos96", "1495");
    mConst->SetValue("rPos97", "1510");
    mConst->SetValue("rPos98", "1525");
    mConst->SetValue("rPos99", "1540");
    mConst->SetValue("rPos100", "1555");
    mConst->SetValue("rPos101", "1570");
    mConst->SetValue("rPos102", "1585");
    mConst->SetValue("rPos103", "1600");
    mConst->SetValue("rPos104", "1615");
    mConst->SetValue("rPos105", "1630");
    mConst->SetValue("rPos106", "1645");
    mConst->SetValue("rPos107", "1660");
    mConst->SetValue("rPos108", "1675");
    mConst->SetValue("rPos109", "1690");
    mConst->SetValue("rPos110", "1705");
    mConst->SetValue("rPos111", "1720");
    mConst->SetValue("rPos112", "1735");
    mConst->SetValue("rPos113", "1750");
    mConst->SetValue("rPos114", "1765");
    mConst->SetValue("rPos115", "1780");
    mConst->SetValue("rPos116", "1795");
    mConst->SetValue("rPos117", "1810");
    mConst->SetValue("rPos118", "1825");
    mConst->SetValue("rPos119", "1840");
    mConst->SetValue("rPos120", "1855");
    mConst->SetValue("rPos121", "1870");
    mConst->SetValue("rPos122", "1885");
    mConst->SetValue("rPos123", "1900");
    mConst->SetValue("rPos124", "1915");
	
	mConst->SetValue("revPos0", "0");
    mConst->SetValue("revPos4", "5");
    mConst->SetValue("revPos5", "20");
    mConst->SetValue("revPos6", "35");
    mConst->SetValue("revPos7", "50");
    mConst->SetValue("revPos8", "65");
    mConst->SetValue("revPos9", "80");
    mConst->SetValue("revPos10", "95");
    mConst->SetValue("revPos11", "110");
    mConst->SetValue("revPos12", "125");
    mConst->SetValue("revPos13", "140");
    mConst->SetValue("revPos14", "155");
    mConst->SetValue("revPos15", "170");
    mConst->SetValue("revPos16", "185");
    mConst->SetValue("revPos17", "200");
    mConst->SetValue("revPos18", "215");
    mConst->SetValue("revPos19", "230");
    mConst->SetValue("revPos20", "245");
    mConst->SetValue("revPos21", "260");
    mConst->SetValue("revPos22", "275");
    mConst->SetValue("revPos23", "290");
    mConst->SetValue("revPos24", "305");
    mConst->SetValue("revPos25", "320");
    mConst->SetValue("revPos26", "335");
    mConst->SetValue("revPos27", "350");
    mConst->SetValue("revPos28", "365");
    mConst->SetValue("revPos29", "380");
    mConst->SetValue("revPos30", "395");
    mConst->SetValue("revPos31", "410");
    mConst->SetValue("revPos32", "425");
    mConst->SetValue("revPos33", "440");
    mConst->SetValue("revPos34", "455");
    mConst->SetValue("revPos35", "470");
    mConst->SetValue("revPos36", "485");
    mConst->SetValue("revPos37", "500");
    mConst->SetValue("revPos38", "515");
    mConst->SetValue("revPos39", "530");
    mConst->SetValue("revPos40", "545");
    mConst->SetValue("revPos41", "560");
    mConst->SetValue("revPos42", "575");
    mConst->SetValue("revPos43", "590");
    mConst->SetValue("revPos44", "605");
    mConst->SetValue("revPos45", "620");
    mConst->SetValue("revPos46", "635");
    mConst->SetValue("revPos47", "650");
    mConst->SetValue("revPos48", "665");
    mConst->SetValue("revPos49", "680");
    mConst->SetValue("revPos50", "695");
    mConst->SetValue("revPos51", "710");
    mConst->SetValue("revPos52", "725");
    mConst->SetValue("revPos53", "740");
    mConst->SetValue("revPos54", "755");
    mConst->SetValue("revPos55", "770");
    mConst->SetValue("revPos56", "785");
    mConst->SetValue("revPos57", "800");
    mConst->SetValue("revPos58", "815");
    mConst->SetValue("revPos59", "830");
    mConst->SetValue("revPos60", "845");
    mConst->SetValue("revPos61", "860");
    mConst->SetValue("revPos62", "875");
    mConst->SetValue("revPos63", "890");
    mConst->SetValue("revPos64", "905");
    mConst->SetValue("revPos65", "920");
    mConst->SetValue("revPos66", "935");
    mConst->SetValue("revPos67", "950");
    mConst->SetValue("revPos68", "965");
    mConst->SetValue("revPos69", "980");
    mConst->SetValue("revPos70", "995");
    mConst->SetValue("revPos71", "1010");
    mConst->SetValue("revPos72", "1025");
    mConst->SetValue("revPos73", "1040");
    mConst->SetValue("revPos74", "1055");
    mConst->SetValue("revPos75", "1070");
    mConst->SetValue("revPos76", "1085");
    mConst->SetValue("revPos77", "1100");
    mConst->SetValue("revPos78", "1115");
    mConst->SetValue("revPos79", "1130");
    mConst->SetValue("revPos80", "1145");
    mConst->SetValue("revPos81", "1160");
    mConst->SetValue("revPos82", "1175");
    mConst->SetValue("revPos83", "1190");
    mConst->SetValue("revPos84", "1205");
    mConst->SetValue("revPos85", "1220");
    mConst->SetValue("revPos86", "1235");
    mConst->SetValue("revPos87", "1250");
    mConst->SetValue("revPos88", "1265");
    mConst->SetValue("revPos89", "1280");
    mConst->SetValue("revPos90", "1295");
    mConst->SetValue("revPos91", "1310");
    mConst->SetValue("revPos92", "1325");
    mConst->SetValue("revPos93", "1340");
    mConst->SetValue("revPos94", "1355");
    mConst->SetValue("revPos95", "1370");
    mConst->SetValue("revPos96", "1385");
    mConst->SetValue("revPos97", "1400");
    mConst->SetValue("revPos98", "1415");
    mConst->SetValue("revPos99", "1430");
    mConst->SetValue("revPos100", "1445");
    mConst->SetValue("revPos101", "1460");
    mConst->SetValue("revPos102", "1475");
    mConst->SetValue("revPos103", "1490");
    mConst->SetValue("revPos104", "1505");
    mConst->SetValue("revPos105", "1520");
    mConst->SetValue("revPos106", "1535");
    mConst->SetValue("revPos107", "1550");
    mConst->SetValue("revPos108", "1565");
    mConst->SetValue("revPos109", "1580");
    mConst->SetValue("revPos110", "1595");
    mConst->SetValue("revPos111", "1610");
    mConst->SetValue("revPos112", "1625");
    mConst->SetValue("revPos113", "1640");
    mConst->SetValue("revPos114", "1655");
    mConst->SetValue("revPos115", "1670");
    mConst->SetValue("revPos116", "1685");
    mConst->SetValue("revPos117", "1700");
    mConst->SetValue("revPos118", "1715");
    mConst->SetValue("revPos119", "1730");
    mConst->SetValue("revPos120", "1745");
    mConst->SetValue("revPos121", "1760");
    mConst->SetValue("revPos122", "1775");
    mConst->SetValue("revPos123", "1790");
    mConst->SetValue("revPos124", "1805");
    mConst->SetValue("revPos125", "1820");
    mConst->SetValue("revPos126", "1835");
    mConst->SetValue("revPos127", "1850");
    mConst->SetValue("revPos128", "1865");
